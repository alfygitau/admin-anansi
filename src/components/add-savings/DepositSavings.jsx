...
export default function AddSavings({
  ...
  const totalAmount = Number(paymentDetails?.savingsAmount || 0);
  ...
  const handlePay = async () => {
    ...
    if (!totalAmount || totalAmount <= 0) {
      setError("Please enter a valid savings deposit amount.");
      return;
    }
    setError("");
    onSubmitStk();
            ...
            <div className="px-8 pt-6 pb-4 flex items-center justify-between border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Deposit funds directly into your SACCO savings account.
                </p>
              </div>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="p-4 border border-[#074073]/30 bg-slate-50/80 rounded-2xl space-y-3.5 shadow-3xs">
                  <div className="flex items-center gap-3">
                    <div className="size-9 rounded-xl bg-amber-50 text-amber-600 border border-amber-100 flex items-center justify-center shrink-0 shadow-3xs">
                      <Coins size={18} />
                    </div>
                    <div>
