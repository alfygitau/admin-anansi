...
export default function SharesSummary({
  isOpen,
  onClose,
  onBack,
  paymentDetails,
  ...
  const { phoneNumber = "", sharesAmount = 0 } = paymentDetails || {};
  const totalAmount = Number(sharesAmount || 0);
            ...
            <div className="px-8 pt-6 pb-4 flex items-center justify-between border-b border-slate-100">
              <div>
                ...
                <h2 className="text-xl font-bold text-[#074073] mt-0.5">
                  Shares Purchase Summary
                </h2>
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Review equity transaction metrics before dispatching M-Pesa
                  prompt.
                </p>
              </div>
