...
export default function FilterApplications({
  ...
  const statusOptions = [
    { value: "pending_guarantor", label: "Pending Guarantor" },
    { value: "pending_credit_committee", label: "Pending Committee" },
  ...
  // Helper to ensure filters.loan_type is always an array
  ...
  const hasValue = (tabId) => {
    ...
    if (tabId === "identifiers")
      return !!(filters.application_number || filters.loan_product_code);
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-8">
              ...
              {activeTab === "identifiers" && (
                <div className="space-y-4">
                  <FilterField label="Application Number" icon={Hash}>
                    <input
                      type="text"
              ...
              {activeTab === "fromDate" && (
                <div className="space-y-5">
                  <FilterField label="Submission Start Date" icon={Calendar}>
                    <input
                      type="date"
              ...
              {activeTab === "toDate" && (
                <div className="space-y-5">
                  <FilterField label="Submission End Date" icon={CalendarDays}>
                    <input
                      type="date"
