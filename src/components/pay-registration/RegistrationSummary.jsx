...
export default function RegistrationSummary({
  ...
  const totalAmount =
    Number(regFee) + Number(sharesAmount || 0) + Number(savingsAmount || 0);
        ...
        <div className="fixed inset-0 z-[100] flex justify-end bg-zinc-950/20 font-sans antialiased text-slate-800">
          ...
          >
            ...
            <div className="px-8 pt-6 pb-4 flex items-center justify-between border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Review transaction metrics before dispatching M-Pesa prompt.
                </p>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-8 py-3 space-y-5">
              ...
              <div className="space-y-2.5">
                ...
                <div className="bg-white border border-slate-200/80 rounded-2xl divide-y divide-slate-100 shadow-3xs overflow-hidden">
                  ...
                  <div className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="size-8 rounded-lg bg-blue-50 text-[#074073] flex items-center justify-center shrink-0">
                        <CreditCard size={15} />
                      </div>
                      <div>
                    ...
                    <div className="p-4 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 font-medium">
                            Initial equity shares
                          </p>
                        </div>
                      </div>
                      <span className="text-xs font-bold text-slate-800">
                        KES {Number(sharesAmount).toLocaleString()}
                      </span>
                    </div>
                  )}
                    ...
                    <div className="p-4 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 font-medium">
                            FOSA / Normal savings deposit
                          </p>
                        </div>
                      </div>
                      <span className="text-xs font-bold text-slate-800">
                        KES {Number(savingsAmount).toLocaleString()}
                      </span>
                    </div>
                  )}
                </div>
              ...
              <div className="p-5 bg-gradient-to-br from-primary to-slate-900 text-white rounded-2xl shadow-md space-y-1">
