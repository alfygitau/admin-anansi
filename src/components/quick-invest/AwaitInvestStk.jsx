...
export default function AwaitInvestStk({
  isOpen,
  onClose,
  onRetry,
  phoneNumber = "",
  ...
  // Countdown timer effect (only ticks during pending state)
  useEffect(() => {
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-wider text-[#074073]">
                    {isSuccess ? "Payment Completed" : "M-Pesa Verification"}
                  </span>
                </div>
                <h2 className="text-xl font-bold text-[#074073] mt-0.5">
                  {isSuccess ? "Payment Confirmed" : "Awaiting STK Push"}
                </h2>
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  {isSuccess
                    ? "Transaction verified successfully via M-Pesa Express."
                ...
                <div className="flex-1 flex flex-col space-y-5 animate-in fade-in duration-300">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed font-medium">
                      The M-Pesa transaction has been successfully confirmed and
