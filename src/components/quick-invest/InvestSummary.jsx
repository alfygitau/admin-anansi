...
export default function InvestSummary({
  ...
  const totalShares = includeShares ? Number(sharesAmount || 0) : 0;
  const totalSavings = includeSavings ? Number(savingsAmount || 0) : 0;
  const totalAmount = totalShares + totalSavings;
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-wider text-[#074073] flex items-center gap-1">
                    <Zap size={12} className="fill-[#074073]" /> Checkout
                    Verification
                  </span>
                </div>
                <h2 className="text-xl font-bold text-[#074073] mt-0.5">
                  Quick Invest Summary
                </h2>
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Review portfolio investment metrics before dispatching M-Pesa
                  prompt.
                </p>
              </div>
