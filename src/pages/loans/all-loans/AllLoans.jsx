              ...
              {isFetching ? (
                ...
                <tr>
                  <td colSpan={6} className="py-8 px-6">
                    <div className="w-full bg-white border border-dashed border-slate-300 rounded-[28px] p-20 text-center">
                      ...
                      <p className="text-xs text-slate-400 font-medium max-w-xs mx-auto mt-2 leading-relaxed">
                        There are no active or legacy records matching under the
                        current filter views.
                      </p>
                    </div>
                  </td>
                </tr>
