    ...
    <div className="w-full space-y-8 font-sans antialiased text-slate-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            {application?.guarantors && application.guarantors.length > 0 ? (
              ...
              <div className="border border-dashed border-slate-200 p-6 rounded-xl bg-slate-50/40 text-center select-none">
                ...
                <p className="text-[11px] text-slate-400 font-medium mt-1">
                  This application doesn't have any peer guarantors assigned to
                  handle the risk profile yet.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="md:col-span-2 w-full">
            {!application.requires_collateral ? (
              ...
              <div className="border border-dashed border-slate-200 p-6 rounded-xl bg-slate-50/40 text-center select-none mt-1">
                ...
                <p className="text-[11px] text-slate-400 font-medium mt-1">
                  This specific loan tier is unsecured and does not require any
                  physical assets tied down as backup security.
                </p>
              </div>
            ) : (
              <div className="space-y-4 mt-1">
                ...
                <div className="space-y-3.5 border-t border-slate-100 pt-5">
                  ...
                  {application?.chattels && application.chattels.length > 0 ? (
          ...
          <div className="md:col-span-2 space-y-3 border-t border-slate-100 pt-5 mt-1">
            ...
            {application?.documents && application.documents.length > 0 ? (
              ...
              <div className="border border-dashed border-slate-200 p-6 rounded-xl bg-slate-50/40 text-center select-none">
                ...
                <p className="text-[11px] text-slate-400 font-medium mt-1">
                  No digital pay slips, security photos, or identity attachments
                  have been linked to this portfolio.
                </p>
              </div>
            )}
          </div>
        ...
        <ApplicationCard title="Review Progress" icon={<Layers size={16} />}>
          ...
          {/* Committee Voting Status with Conditional Dynamic Metrics */}
        ...
        >
          {!application?.disbursement ? (
            ...
            <div className="col-span-full flex flex-col gap-5 w-full">
              ...
              {application.disbursement.status === "failed" && (
                <div className="bg-rose-50/60 border border-rose-100 rounded-2xl p-4 flex gap-3 items-start w-full">
                  <AlertCircle
                    size={16}
                  ...
                  <div className="space-y-1 flex-1">
                    <h4 className="text-xs font-black text-rose-800 uppercase tracking-wide">
                      Payout Attempt Unsuccessful
                    </h4>
                    <p className="text-xs text-rose-700/90 font-medium leading-relaxed">
                      The system couldn't complete the automated{" "}
                      {application.disbursement.method} transfer.
                      <span className="block font-mono bg-white/60 border border-rose-100 text-[11px] text-rose-600 px-2 py-1 rounded-md mt-1.5 break-all">
                        System Response:{" "}
                        {application.disbursement.failure_reason}
                      </span>
                    </p>
                  </div>
                </div>
